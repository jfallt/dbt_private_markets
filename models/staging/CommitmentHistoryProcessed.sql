...
LEFT JOIN [dbo].[Portfolio] ff1 ON ff1.ServiceProviderName = ch.Portfolio
LEFT JOIN (
...
LEFT JOIN [dbo].[Portfolio] ff2 ON ff2.ShortName = b.ShortName
LEFT JOIN [dbo].[GPFund] gpf ON gpf.ServiceProviderName = ch.Investment
LEFT JOIN (
...
LEFT JOIN [dbo].[GPFund]  gpf2 ON gpf2.OrgGuid = b2.OrgGUID